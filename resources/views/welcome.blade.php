    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
        ...
        <div class="container">
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Sizning xabaringiz yuborildi</strong> 
    ...
    <section class="bg-light" id="portfolio">
        ...
        <div id="projects-slider" class="owl-theme owl-carousel">
            ...
            <div class="project">
                ...
                <img height="400px" src="{{ asset('/storage/' .  $project->image ) }}" alt="">
                <div class="content">
                    <h2>{{ $project->name }}</h2>
                    <h6>{{ $project->title }}</h6>
                </div>
            ...
            <div class="row justify-content-center">
                @foreach ($teams as $team)
                    ...
                    <div class="team-member">
                        <div class="image">
                            <img height="400px" src="{{ asset('/storage/' . $team->image) }}" alt="">
                                ...
                                <form class="p-lg-5 col-12 row g-3" action="{{ route('sendcontact') }}" method="POST">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="message" placeholder="This is looking great and nice."
                                            class="form-control" id="message" rows="4"></textarea>
                                    </div>
